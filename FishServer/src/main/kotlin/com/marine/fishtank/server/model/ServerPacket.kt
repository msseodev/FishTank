...
data class ServerPacket(
    ...
    companion object {
        fun createFromJson(json: String): ServerPacket {
            val gson = Gson()
            val packet = gson.fromJson(json, ServerPacket::class.java)

            val user = gson.fromJson(gson.toJson(packet.obj), User::class.java)

            return packet.copy(obj = user)
        }
    }
}
